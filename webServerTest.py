    ...
    def run(self):
        ...
        while loopFlag:
            ...
            if sumRequest<self.maxNums:     #若访问次数不够，则继续访问
                ...
                try:
                    conn = httplib.HTTPConnection("127.0.0.1",9090) #开始请求http服务器
                    conn.request("GET",'/')
...
if __name__ == "__main__":
    ...
    print "×××××开始测试!×××××" 
    print "测试线程数：",threadNum
    print "测试总请求数:",requestNum
    ...
    print "×××××测试结束!×××××"
    print "总次数:",sumRequest
    print "成功次数：",successRequest
    print "测试时长：",(endTime-startTime).seconds,"秒"
    print "最大请求时间:",maxTime,"毫秒"
    print "最小请求时间:",minTime,"毫秒"
    print "平均请求时间:",averageTime,"毫秒"
